...
<div class="row position-absolute top-50 start-50 translate-middle">
    <div class="col-sm-3 mb-3 mb-sm-0 " style="padding:3px">
        ...
        <div class="card-body text-center">
            ...
            <a href="../student/AddStudent.php" class="btn btn-primary">Go</a>
        </div>
        </div>
    </div>
    <div class="col-sm-3" style="padding:3px">
        ...
        <div class="card-body text-center">
            ...
            <a href="../student/searchStudent.php" class="btn btn-primary">Go</a>
        </div>
        </div>
    </div>
    <div class="col-sm-3" style="padding:3px">
        ...
        <div class="card-body text-center">
            ...
            <a href="../student/listStudents.php" class="btn btn-primary">Go</a>
        </div>
        </div>
    </div>
